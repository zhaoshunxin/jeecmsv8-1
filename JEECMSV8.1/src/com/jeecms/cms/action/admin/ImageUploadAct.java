...
public class ImageUploadAct extends CommonUpload {
	...
	public String execute(
		...
		System.out.println("####imageupload0");
		...
		System.out.println("####imageupload2");
		String origName = file.getOriginalFilename();
		String ext = FilenameUtils.getExtension(origName).toLowerCase(
				Locale.ENGLISH);
		System.out.println("####imageupload3");
		try {
			String fileUrl;
			System.out.println("####imageftp" + site.getSyncPageFtp());
			if (site.getConfig().getUploadToDb()) {
				System.out.println("####imageftp1");
